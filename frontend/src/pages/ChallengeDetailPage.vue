  ...
  <template class="min-h-screen">
    ...
    <div class="p-4 space-y-8">
      ...
      <div v-if="solvers.length" class="mt-8">
        <h2 class="text-xl font-semibold text-blue-800 mb-4">Solvers</h2>
        <ul>
          <li v-for="solver in solvers" :key="solver.user_id" class="flex justify-between py-2">
            <span class="font-medium">{{ solver.username }}</span>
